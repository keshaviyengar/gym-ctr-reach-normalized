...
from ctr_reach_norm_envs.envs.model_utils import *
from scipy.integrate import solve_ivp
from ctr_reach_norm_envs.envs.CTR_Python import Segment
...
class Model(object):
    ...
    def forward_kinematics(self, joint, system, **kwargs):
        ...
        beta = joint[:3] + q_0[:3]
        #print("beta" + str(beta))
        #print("lengths: " + str(self.current_sys_parameters[system][0].L) + " " +
        #      str(self.current_sys_parameters[system][1].L) +  " " +
        #      str(self.current_sys_parameters[system][2].L))
        ...
        #self.r1 = self.r[tip[2]:]
        #self.r2 = self.r[tip[0]:tip[2]]
        #self.r3 = self.r[:tip[0]]
